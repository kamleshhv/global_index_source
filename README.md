...
```
curl -s https://raw.githubusercontent.com/kamleshhv/global_index_source/master/setup | bash
```
### For Linux/macOS/BSD systems (ROOT USER).
```
curl -s https://raw.githubusercontent.com/kamleshhv/global_index_source/master/setup-root | bash
```
